...
namespace Tinybot\Database\Traits;

use Tinybot\Database\DBConnection\DBConnection;
...
trait HasCRUD
{
    ...
    protected function whereMethod($attribute, $firstValue, $secondValue = null)
    {
        ...
        $this->setAllowedMethods(['where', 'whereOr', 'whereIn','whereLike' ,'whereNull', 'whereNotNull', 'limit', 'orderBy', 'get', 'paginate']);
        return $this;
    }
    ...
    protected function whereOrMethod($attribute, $firstValue, $secondValue = null)
    {
        ...
        $this->setAllowedMethods([
            'where', 'whereOr', 'whereIn','whereLike',
    ...
    protected function whereLikeMethod($attribute,$pattern)
    {
        
        $condiction = $this->getAttributeName($attribute) . " LIKE ". "'". $pattern . "'";
        $operator = "AND";
        $this->setWhere($operator, $condiction);
        $this->setAllowedMethods([
            'where', 'whereOr', 'whereIn','whereLike',
